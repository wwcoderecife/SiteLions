...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<section id="header" class="appear">
		...
		<div class="navbar navbar-fixed-top" role="navigation" data-0="line-height:100px; height:100px; background-color:rgba(255,203,8);" data-300="line-height:60px; height:60px; background-color:rgba(0,0,0,1);">
			
				<div class="navbar-header">
					<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
						<span class="fa fa-bars color-white"></span>
					</button>
					<h1><a class="navbar-brand" href="index.html" data-0="line-height:90px;" data-300="line-height:50px;">Lions Clube International - DMLA
					</a></h1>
				</div>
...
>>>>>>> 249f544acdaafd9ba45386f7b05b2a5e74aaf76b
							
							<div class="caption header" data-animate="slideAppearDownToUp" data-delay="500" data-length="300">
								>
								<div class="caption-sub" data-animate="slideAppearUpToDown" data-delay="800" data-length="300"><h4><span> </span></h4></div>
...
<<<<<<< HEAD
              ...
              <div class="slide-body" data-group="slide">
                ...
                <div class="caption header" data-animate="slideAppearUpToDown" data-delay="500" data-length="300">
                  <h2></h2>
                  <div class="caption-sub" data-animate="slideAppearLeftToRight" data-delay="800" data-length="300"><h4></h4></div>
				  <div class="caption-sub" data-animate="slideAppearDownToUp" data-delay="1200" data-length="300"><h3><span></span></h3></div>
...
>>>>>>> 249f544acdaafd9ba45386f7b05b2a5e74aaf76b
      ...
      <!-- Responsive slider - END -->
		...
		<!-- Relatórios -->
		<section id="relatorio" class="section pad-bot5 bg-green">
		<div class="container"> 
  ...
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingOne">
      <h4 class="panel-title">
        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          Clique aqui para escolher um relatório
        </a>
      </h4>
    </div>
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      ...
      <div class="panel-body">
        ...
        <a data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">

        <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
        <div class="portfolio-hover">
         Inscritos por Distrito x Clube
        </div>
       </a>
      </div>
      ...
      <div class="panel-body">
        ...
        <div class="portfolio-hover">
         Top 5 Idosos/Jovens
         <!-- constando nome e a data do nascimento. Na ordem decrescente, ou seja, o mais velho primeiro. Com nome do Clube e Distrito-->
         <!-- constando nome e a data do nascimento. Na ordem crescente, ou seja, o mais novo primeiro. Com nome do Clube e Distrito.-->
        </div>
       </a>
      </div>
      ...
      <div class="panel-body">
        ...
        <div class="portfolio-hover">
         Estatísticas <!--Total de inscritos / Total por Clubes / Total por Distrito / Total de LEOS -->
        </div>
       </a>
      </div>
      ...
      <div class="panel-body">
        ...
        <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
         ...
         Top Cinco Club <!--Dos cinco Clubes com maior número de inscritos (CL/CaL/Dom/Leo) -->
       </a>
      </div>
     ...
     <div class="panel-body">
        ...
        <a href="#portfolioModal8" class="portfolio-link" data-toggle="modal">
         ...
         Comitê Credenciais Delegados Natos <!--Nome / Clube / Distrito dos Delegados Natos. Na ordem alfabética. Será documento do Comitê de Credenciais a ser passado para o Comitê de Eleições.-->
       </a>
      </div>
     ...
     <div class="panel-body">
        ...
        <a href="#portfolioModal9" class="portfolio-link" data-toggle="modal">
         ...
         Comitê Credenciais Delegados <!--Comitê de Eleições.Nome / Clube / Distrito dos Delegados. Uma relação para cada Clube. Nomes na ordem alfabética. Será documento do Comitê de Credenciais a ser passado para o Comitê de Eleições.-->
       </a>
      </div>
     ...
     <div class="panel-body">
        ...
        <a href="#portfolioModal10" class="portfolio-link" data-toggle="modal">
         ...
         Suplentes <!--Nome / Clube / Distrito dos Suplentes. Uma relação para cada Clube. Nomes na ordem alfabética. Estes dados podem ficar abaixo, com bom espaço, da relação dos Delegados.-->
       </a>
      </div>
     ...
     <div class="panel-body">
        ...
        <a href="#portfolioModal11" class="portfolio-link" data-toggle="modal">
          ...
          Folha de Votação / Delegados Natos <!--Nome / Clube / Distrito dos Delegados Natos. Na ordem alfabética. Espaço duplo entre os nomes e campo para colher assinatura, com tracejado. Será usado pelo Comitê de Eleições como Folha de Votação.-->
       </a>
      </div>
     ...
     <div class="panel-body">
        ...
        <a href="#portfolioModal12" class="portfolio-link" data-toggle="modal">
         ...
         Folha de Votação / Delegados <!--Nome / Clube / Distrito dos Delegados Uma relação para cada Clube. Nomes na ordem alfabética. Espaço duplo entre os nomes e campo para colher assinatura, com tracejado. Será usado pelo Comitê de Eleições como Folha de Votação.-->
       </a>
      </div>
    </div>
  </div>
 ...
 <!-- Relatório Modal 2 / Inscritos por Distrito x Clube -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <!-- Relatório Details Go Here -->
                            <h2>Inscritos por Distrito x Clube</h2>
                            <?php include 'relatorios/distrito_clube.php'; ?>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i>  Voltar </button>
                        </div>
                    </div>
                </div>
    ...
    <!-- Relatório Modal 3 / Top Cinco Older -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <!-- Relatório Details Go Here -->
                            <h2>Top 5 Idosos/Jovens</h2>
                            <?php include 'relatorios/top_five_idosos_jovens.php'; ?>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i>  Voltar </button>
                        </div>
                    </div>
                </div>
    ...
    <!-- Relatório Modal 5 / Estatísticas -->
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <!-- Relatório Details Go Here -->
                            <h2>Estatísticas</h2>
                            <?php include 'relatorios/estatistica.php'; ?>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i>  Voltar </button>
                        </div>
                    </div>
                </div>
    ...
    <!-- Relatório Modal 6 / Top Cinco Club -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <!-- Relatório Details Go Here -->
                            <h2>Top Cinco Club</h2>
                            <?php include 'relatorios/top_five_club.php'; ?>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i>  Voltar </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <?php include 'relatorios/delegados_natos.php'; ?>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i>  Voltar </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <!-- Relatório Details Go Here -->
                            <h2>Comitê Credenciais Delegados Natos</h2>
                            <?php include 'relatorios/credenciais_delegados_natos.php'; ?>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i>  Voltar </button>
                        </div>
                    </div>
                </div>
    ...
    <!-- Relatório Modal 9 / Comitê Credenciais Delegados -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <!-- Relatório Details Go Here -->
                            <h2>Comitê Credenciais Delegados</h2>
                            <?php include 'relatorios/credenciais_delegados.php'; ?>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i>  Voltar </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <!-- Relatório Details Go Here -->
                            <h2>Suplentes</h2>
                            <?php include 'relatorios/suplentes.php'; ?>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i>  Voltar </button>
                        </div>
                    </div>
                </div>
    ...
    <!-- Relatório Modal 11 / Folha de Votação / Delegados Natos -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <!-- Relatório Details Go Here -->
                            <h2>Folha de Votação / Delegados Natos</h2>
                            <?php include 'relatorios/folha_votacao_delegados_natos.php'; ?>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i>  Voltar </button>
                        </div>
                    </div>
                </div>
 ...
 <!-- Relatório Modal 11 / Folha de Votação / Delegados -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <!-- Relatório Details Go Here -->
                            <h2>Folha de Votação / Delegados</h2>
                            <?php include 'relatorios/folha_votacao_delegados.php'; ?>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i>  Voltar </button>
                        </div>
                    </div>
                </div>
