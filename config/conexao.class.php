...
class conexao
{
    ...
    */
    ...
    private $db_host = 'localhost'; // Nome do Host no windows azure// br-cdbr-azure-south-b.cloudapp.net
    private $db_user = 'root'; // usuario do banco //b05f3f43efb9ee
    private $db_pass = ''; // senha do usuario do banco // 9e270c2e
