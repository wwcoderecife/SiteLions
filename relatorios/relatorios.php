		...
		<div class="navbar navbar-fixed-top" role="navigation" style="line-height:60px; height:60px; background-color:rgba(0,0,0,1);">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav" style="margin-top:5px;" >
						...
						<li><a href="#team">Delegado Nato/Delegado Nato Suplente</a></li>
...
Com Nome / Clube / Distrito dos Delegados. Uma relação para cada Clube. Nomes na ordem alfabética. Espaço duplo entre os nomes e campo para colher assinatura, com tracejado. Será usado pelo Comitê de Eleições como Folha de Votação. -->
	...
	<!-- spacer section:testimonial -->
		...
		<div class="container">
				...
				<div class="row mar-bot10">
					<div class="col-md-offset-3 col-md-6">
						...
						<div class="wow bounceIn">
							...
							<h2 class="section-heading animated" data-animation="bounceInUp">Delegado Nato/Delegado Suplente</h2>
				...
				<div class="row">
					<?php
						$delegados = mysql_query("SELECT * FROM `tb_membros` ORDER BY nome ASC");
						$delegadosNatos = mysql_query("SELECT * FROM tb_membros where nato = 1 order by nome");
						$delegadosSuplente = mysql_query("SELECT * FROM tb_membros where delegado_suplente = 1 order by nome");
        				...
        				<table class='table table-condensed table-hover'>
						    ...
						    <tbody>";
        				// vamos criar a visualização 
        				while ($dados = mysql_fetch_array($delegadosNatos)) { 
        				 echo "<tr>
						        <td>".$dados["nome"]."</td>
						        <td>".$dados["nome_clube"]."</td>
						        <td>".$dados["distrito"]."</td>
        				...
        				<thead>
						    ...
						    ";
  						// vamos criar a visualização 
        				while ($dados = mysql_fetch_array($delegadosSuplente)) { 
        				 echo "<tr>
						        <td>".$dados["nome"]."</td>
						        <td>".$dados["nome_clube"]."</td>
						        <td>".$dados["distrito"]."</td>
						        <td>".$dados["delegado_suplente"]."</td>
						      </tr>";
        				}; 
